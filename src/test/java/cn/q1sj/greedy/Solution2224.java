...
public class Solution2224 {
	...
	@Test
	public void test() {
		Solution2224 solution = new Solution2224();
		Assert.assertEquals(3, solution.convertTime("02:30", "04:35"));
		Assert.assertEquals(1, solution.convertTime("11:00", "11:01"));
	}
	...
	public int convertTime(String current, String correct) {
		...
		long correctMinutes = toMinutes(correct);
		int step = 0;
